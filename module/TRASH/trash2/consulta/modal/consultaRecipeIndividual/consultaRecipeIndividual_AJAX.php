  ...
  if ($_POST['accion'] == "edit_consultaRecipeIndividual")
  {
 ...
 if ($_POST['accion'] == "edit_consultaRecipeIndividual")
 {
   ...
   $JSON = $CONSULTA->soyjson($CONSULTA->tabla,'modal','consultaRecipeIndividual');
 ...
 if ($_POST['accion'] == "new_consultaRecipeIndividual")
 {
 ...
 if (($_POST['accion'] == "save_consultaRecipeIndividual"))
 {
   ...
   $JSON = $CONSULTA->soyjsondatatable($CONSULTA->tabla,'datatable','consultaRecipeIndividual');
