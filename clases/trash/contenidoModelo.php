...
class contenidoModelo extends padreModelo {

        private $value_default = "contenido.json";
        public $vista = "contenido";
        public $tabla = "contenido";
...
public $concol="";
 ...
 public function set_concue($x, $w = 0) { 
       $nombre = 'concue';  
      $x = $this->_fix_type($nombre, $x);
      $this->concue = $x; 
       if ($w > 0) {
 ...
 public function set_conpub($x, $w = 0) { 
       $nombre = 'conpub';  
      $x = $this->_fix_type($nombre, $x);
      $this->conpub = $x; 
       if ($w > 0) {
 ...
 public function set_conaut($x, $w = 0) { 
       $nombre = 'conaut';  
      $x = $this->_fix_type($nombre, $x);
      $this->conaut = $x; 
       if ($w > 0) {
 ...
 public function set_concol($x, $w = 0) { 
       $nombre = 'concol';  
      $x = $this->_fix_type($nombre, $x);
      $this->concol = $x; 
       if ($w > 0) {
