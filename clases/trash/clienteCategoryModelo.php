...
class clienteCategoryModelo extends padreModelo {

            private $value_default = "clienteCategory.json";
            public $vista = "clienteCategory";
            public $tabla = "clienteCategory";
...
public $clcreg="";
 ...
 public function set_clcid($x, $w = 0) { 
       $nombre = 'clcid';  
      $x = $this->_fix_type($nombre, $x);
      $this->clcid = $x; 
       if ($w > 0) {
 ...
 public function set_clcden($x, $w = 0) { 
       $nombre = 'clcden';  
      $x = $this->_fix_type($nombre, $x);
      $this->clcden = $x; 
       if ($w > 0) {
 ...
 public function set_clcest($x, $w = 0) { 
       $nombre = 'clcest';  
      $x = $this->_fix_type($nombre, $x);
      $this->clcest = $x; 
       if ($w > 0) {
 ...
 public function set_clcreg($x, $w = 0) { 
       $nombre = 'clcreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->clcreg = $x; 
       if ($w > 0) {
