...
class logModelo extends padreModelo {

 private $value_default = "log.json";
 public $vista = "log";
 public $tabla = "log";
 ...
 public function formatos_especiales($data)
 {
      ...
      */
             ...
             public function set_logid($x, $w = 0) { 
               $nombre = 'logid';  
               $x = $this->_fix_type($nombre, $x);
               $this->logid = $x; 
               if ($w > 0) {
           ...
           public function set_logusu($x, $w = 0) { 
             $nombre = 'logusu';  
             $x = $this->_fix_type($nombre, $x);
             $this->logusu = $x; 
             if ($w > 0) {
         ...
         public function set_logden($x, $w = 0) { 
           $nombre = 'logden';  
           $x = $this->_fix_type($nombre, $x);
           $this->logden = $x; 
           if ($w > 0) {
       ...
       public function set_logsql($x, $w = 0) { 
         $nombre = 'logsql';  
         $x = $this->_fix_type($nombre, $x);
         $this->logsql = $x; 
         if ($w > 0) {
     ...
     public function set_logreg($x, $w = 0) { 
       $nombre = 'logreg';  
       $x = $this->_fix_type($nombre, $x);
       $this->logreg = $x; 
       if ($w > 0) {
   ...
   public function get_logreg() { 
     return $this->logreg; 
   } 


public function log_inicio($PARAMETRO){

$this->set_logusu(3);
$this->set_logden('inicioss');
$this->set_logreg($this->reg());
$this->save();
}
