...
class pagoDetalleModelo extends padreModelo {

             private $value_default = "pagoDetalle.json";
             public $vista = "pagoDetalle";
             public $tabla = "pagoDetalle";
...
public $dpgreg="";
 ...
 public function set_dpgid($x, $w = 0) { 
       $nombre = 'dpgid';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgid = $x; 
       if ($w > 0) {
 ...
 public function set_dpgpagid($x, $w = 0) { 
       $nombre = 'dpgpagid';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgpagid = $x; 
       if ($w > 0) {
 ...
 public function get_dpgpagid() { 
 return $this->dpgpagid; 
 } 
 ...
 public function set_dpgcan($x, $w = 0) { 
       $nombre = 'dpgcan';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgcan = $x; 
       if ($w > 0) {
 ...
 public function set_dpgsrvid($x, $w = 0) { 
       $nombre = 'dpgsrvid';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgsrvid = $x; 
       if ($w > 0) {
 ...
 public function get_dpgsrvid() { 
 return $this->dpgsrvid; 
 } 
 ...
 public function set_dpgtot($x, $w = 0) { 
       $nombre = 'dpgtot';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgtot = $x; 
       if ($w > 0) {
 ...
 public function set_dpgest($x, $w = 0) { 
       $nombre = 'dpgest';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgest = $x; 
       if ($w > 0) {
 ...
 public function set_dpgreg($x, $w = 0) { 
       $nombre = 'dpgreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->dpgreg = $x; 
       if ($w > 0) {
