  ...
  if ($_POST['accion'] == "edit_formPacienteMinimo")
  {
 ...
 if ($_POST['accion'] == "edit_formPacienteMinimo")
 {
   ...
   $JSON = $PACIENTE->soyjson($PACIENTE->tabla,'modal','formPacienteMinimo');
 ...
 if ($_POST['accion'] == "new_formPacienteMinimo")
 {
 ...
 if (($_POST['accion'] == "save_formPacienteMinimo"))
 {
