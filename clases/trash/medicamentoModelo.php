...
class medicamentoModelo extends padreModelo {

             private $value_default = "medicamento.json";
             public $vista = "medicamento";
             public $tabla = "medicamento";
...
public $mdmest="";
 ...
 public function set_mdmid($x, $w = 0) { 
       $nombre = 'mdmid';  
      $x = $this->_fix_type($nombre, $x);
      $this->mdmid = $x; 
       if ($w > 0) {
 ...
 public function set_mdmden($x, $w = 0) { 
       $nombre = 'mdmden';  
      $x = $this->_fix_type($nombre, $x);
      $this->mdmden = $x; 
       if ($w > 0) {
 ...
 public function set_mdmcod($x, $w = 0) { 
       $nombre = 'mdmcod';  
      $x = $this->_fix_type($nombre, $x);
      $this->mdmcod = $x; 
       if ($w > 0) {
 ...
 public function set_mdmreg($x, $w = 0) { 
       $nombre = 'mdmreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->mdmreg = $x; 
       if ($w > 0) {
 ...
 public function set_mdmusuid($x, $w = 0) { 
       $nombre = 'mdmusuid';  
      $x = $this->_fix_type($nombre, $x);
      $this->mdmusuid = $x; 
       if ($w > 0) {
 ...
 public function get_mdmusuid() { 
 return $this->mdmusuid; 
 } 
 ...
 public function set_mdmest($x, $w = 0) { 
       $nombre = 'mdmest';  
      $x = $this->_fix_type($nombre, $x);
      $this->mdmest = $x; 
       if ($w > 0) {
