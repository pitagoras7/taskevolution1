...
class guitarraModelo extends padreModelo {

             private $value_default = "guitarra.json";
             public $vista = "guitarra";
             public $tabla = "guitarra";
...
public $guiamp="";
 ...
 public function set_guiamp($x, $w = 0) { 
       $nombre = 'guiamp';  
      $x = $this->_fix_type($nombre, $x);
      $this->guiamp = $x; 
       if ($w > 0) {
 ...
 public function get_guiamp() { 
 return $this->guiamp; 
 } 


 public function set_guiid($x, $w = 0) { 
       $nombre = 'guiid';  
      $x = $this->_fix_type($nombre, $x);
      $this->guiid = $x; 
       if ($w > 0) {
 ...
 public function set_guiden($x, $w = 0) { 
       $nombre = 'guiden';  
      $x = $this->_fix_type($nombre, $x);
      $this->guiden = $x; 
       if ($w > 0) {
 ...
 public function set_guiest($x, $w = 0) { 
       $nombre = 'guiest';  
      $x = $this->_fix_type($nombre, $x);
      $this->guiest = $x; 
       if ($w > 0) {
 ...
 public function set_guireg($x, $w = 0) { 
       $nombre = 'guireg';  
      $x = $this->_fix_type($nombre, $x);
      $this->guireg = $x; 
       if ($w > 0) {
