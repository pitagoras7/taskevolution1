...
class enfermedadModelo extends padreModelo {

             private $value_default = "enfermedad.json";
             public $vista = "enfermedad";
             public $tabla = "enfermedad";
...
public $enfest="";
 ...
 public function set_enfid($x, $w = 0) { 
       $nombre = 'enfid';  
      $x = $this->_fix_type($nombre, $x);
      $this->enfid = $x; 
       if ($w > 0) {
 ...
 public function set_enfcod($x, $w = 0) { 
       $nombre = 'enfcod';  
      $x = $this->_fix_type($nombre, $x);
      $this->enfcod = $x; 
       if ($w > 0) {
 ...
 public function set_enfden($x, $w = 0) { 
       $nombre = 'enfden';  
      $x = $this->_fix_type($nombre, $x);
      $this->enfden = $x; 
       if ($w > 0) {
 ...
 public function set_enfreg($x, $w = 0) { 
       $nombre = 'enfreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->enfreg = $x; 
       if ($w > 0) {
 ...
 public function set_enfest($x, $w = 0) { 
       $nombre = 'enfest';  
      $x = $this->_fix_type($nombre, $x);
      $this->enfest = $x; 
       if ($w > 0) {
