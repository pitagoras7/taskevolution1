...
class salonModelo extends padreModelo {

        private $value_default = "salon.json";
        public $vista = "salon";
        public $tabla = "salon";
        ...
        public function _config_($json="")
        {
          ...
          $str_datos = file_get_contents($_SERVER['DOCUMENT_ROOT']."/skydiners/module/salon/data/".$this->value_default);
...
public $salava="";
 ...
 public function set_salid($x, $w = 0) { 
       $nombre = 'salid';  
      $x = $this->_fix_type($nombre, $x);
      $this->salid = $x; 
       if ($w > 0) {
 ...
 public function set_salden($x, $w = 0) { 
       $nombre = 'salden';  
      $x = $this->_fix_type($nombre, $x);
      $this->salden = $x; 
       if ($w > 0) {
 ...
 public function set_salest($x, $w = 0) { 
       $nombre = 'salest';  
      $x = $this->_fix_type($nombre, $x);
      $this->salest = $x; 
       if ($w > 0) {
 ...
 public function set_salreg($x, $w = 0) { 
       $nombre = 'salreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->salreg = $x; 
       if ($w > 0) {
 ...
 public function set_salava($x, $w = 0) { 
       $nombre = 'salava';  
      $x = $this->_fix_type($nombre, $x);
      $this->salava = $x; 
       if ($w > 0) {
