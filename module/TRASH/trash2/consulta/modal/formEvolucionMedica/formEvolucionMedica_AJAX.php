  ...
  if ($_POST['accion'] == "edit_formEvolucionMedica")
  {
 ...
 if ($_POST['accion'] == "new_formEvolucionMedica")
 {
 ...
 if (($_POST['accion'] == "save_formEvolucionMedica"))
 {
   ...
   $JSON = $CONSULTA->soyjsondatatable($CONSULTA->tabla,'datatable','formEvolucionMedica');
