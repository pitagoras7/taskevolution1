...
class suggestionModelo extends padreModelo {

        private $value_default = "suggestion.json";
        public $vista = "suggestion";
        public $tabla = "suggestion";
...
public $sugreg="";
 ...
 public function set_sugid($x, $w = 0) { 
       $nombre = 'sugid';  
      $x = $this->_fix_type($nombre, $x);
      $this->sugid = $x; 
       if ($w > 0) {
 ...
 public function set_sugden($x, $w = 0) { 
       $nombre = 'sugden';  
      $x = $this->_fix_type($nombre, $x);
      $this->sugden = $x; 
       if ($w > 0) {
 ...
 public function set_sugest($x, $w = 0) { 
       $nombre = 'sugest';  
      $x = $this->_fix_type($nombre, $x);
      $this->sugest = $x; 
       if ($w > 0) {
 ...
 public function set_sugreg($x, $w = 0) { 
       $nombre = 'sugreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->sugreg = $x; 
       if ($w > 0) {
