...
class historiaCategoryModelo extends padreModelo {

             private $value_default = "historiaCategory.json";
             public $vista = "historiaCategory";
             public $tabla = "historiaCategory";
...
public $chsest="";
 ...
 public function set_chsid($x, $w = 0) { 
       $nombre = 'chsid';  
      $x = $this->_fix_type($nombre, $x);
      $this->chsid = $x; 
       if ($w > 0) {
 ...
 public function set_chsusuid($x, $w = 0) { 
       $nombre = 'chsusuid';  
      $x = $this->_fix_type($nombre, $x);
      $this->chsusuid = $x; 
       if ($w > 0) {
 ...
 public function get_chsusuid() { 
 return $this->chsusuid; 
 } 
 ...
 public function set_chscod($x, $w = 0) { 
       $nombre = 'chscod';  
      $x = $this->_fix_type($nombre, $x);
      $this->chscod = $x; 
       if ($w > 0) {
 ...
 public function set_chsden($x, $w = 0) { 
       $nombre = 'chsden';  
      $x = $this->_fix_type($nombre, $x);
      $this->chsden = $x; 
       if ($w > 0) {
 ...
 public function set_chsest($x, $w = 0) { 
       $nombre = 'chsest';  
      $x = $this->_fix_type($nombre, $x);
      $this->chsest = $x; 
       if ($w > 0) {
