  ...
  if ($_POST['accion'] == "edit_consultaReporteIndividual")
  {
 ...
 if ($_POST['accion'] == "edit_consultaReporteIndividual")
 {
   ...
   $JSON = $CONSULTA->soyjson($CONSULTA->tabla,'modal','consultaReporteIndividual');
 ...
 if ($_POST['accion'] == "new_consultaReporteIndividual")
 {
 ...
 if (($_POST['accion'] == "save_consultaReporteIndividual"))
 {
   ...
   $JSON = $CONSULTA->soyjsondatatable($CONSULTA->tabla,'datatable','consultaReporteIndividual');
