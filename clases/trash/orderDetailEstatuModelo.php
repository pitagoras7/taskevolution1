...
class orderDetailEstatuModelo extends padreModelo {

    private $value_default = "orderDetailEstatu.json";
    public $vista = "orderDetailEstatu";
    public $tabla = "orderDetailEstatu";
    public $id_dependiente = "";

    public $orderDetailEstatu_enespera      = 56;
    public $orderDetailEstatu_enpreparacion = 57;
    public $orderDetailEstatu_enentrega     = 58;
    public $orderDetailEstatu_entregada     = 59;
...
public $odeobs="";
 ...
 public function set_odeid($x, $w = 0) { 
       $nombre = 'odeid';  
      $x = $this->_fix_type($nombre, $x);
      $this->odeid = $x; 
       if ($w > 0) {
 ...
 public function set_odeusuid($x, $w = 0) { 
       $nombre = 'odeusuid';  
      $x = $this->_fix_type($nombre, $x);
      $this->odeusuid = $x; 
       if ($w > 0) {
 ...
 public function get_odeusuid() { 
 return $this->odeusuid; 
 } 
 ...
 public function set_odeoddid($x, $w = 0) { 
       $nombre = 'odeoddid';  
      $x = $this->_fix_type($nombre, $x);
      $this->odeoddid = $x; 
       if ($w > 0) {
 ...
 public function get_odeoddid() { 
 return $this->odeoddid; 
 } 
 ...
 public function set_odetipid($x, $w = 0) { 
       $nombre = 'odetipid';  
      $x = $this->_fix_type($nombre, $x);
      $this->odetipid = $x; 
       if ($w > 0) {
 ...
 public function get_odetipid() { 
 return $this->odetipid; 
 } 
 ...
 public function set_odereg($x, $w = 0) { 
       $nombre = 'odereg';  
      $x = $this->_fix_type($nombre, $x);
      $this->odereg = $x; 
       if ($w > 0) {
 ...
 public function set_odeest($x, $w = 0) { 
       $nombre = 'odeest';  
      $x = $this->_fix_type($nombre, $x);
      $this->odeest = $x; 
       if ($w > 0) {
 ...
 public function set_odeobs($x, $w = 0) { 
       $nombre = 'odeobs';  
      $x = $this->_fix_type($nombre, $x);
      $this->odeobs = $x; 
       if ($w > 0) {
