...
class equipoModelo extends padreModelo {

        private $value_default = "equipo.json";
        public $vista = "equipo";
        public $tabla = "equipo";
...
public $equest="";
 ...
 public function set_equid($x, $w = 0) { 
       $nombre = 'equid';  
      $x = $this->_fix_type($nombre, $x);
      $this->equid = $x; 
       if ($w > 0) {
 ...
 public function set_equnom($x, $w = 0) { 
       $nombre = 'equnom';  
      $x = $this->_fix_type($nombre, $x);
      $this->equnom = $x; 
       if ($w > 0) {
 ...
 public function set_equreg($x, $w = 0) { 
       $nombre = 'equreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->equreg = $x; 
       if ($w > 0) {
 ...
 public function set_equest($x, $w = 0) { 
       $nombre = 'equest';  
      $x = $this->_fix_type($nombre, $x);
      $this->equest = $x; 
       if ($w > 0) {
