...
class mesaCategoryModelo extends padreModelo {

        private $value_default = "mesaCategory.json";
        public $vista = "mesaCategory";
        public $tabla = "mesaCategory";
...
public $mscreg="";
 ...
 public function set_mscid($x, $w = 0) { 
       $nombre = 'mscid';  
      $x = $this->_fix_type($nombre, $x);
      $this->mscid = $x; 
       if ($w > 0) {
 ...
 public function set_mscden($x, $w = 0) { 
       $nombre = 'mscden';  
      $x = $this->_fix_type($nombre, $x);
      $this->mscden = $x; 
       if ($w > 0) {
 ...
 public function set_mscest($x, $w = 0) { 
       $nombre = 'mscest';  
      $x = $this->_fix_type($nombre, $x);
      $this->mscest = $x; 
       if ($w > 0) {
 ...
 public function set_mscreg($x, $w = 0) { 
       $nombre = 'mscreg';  
      $x = $this->_fix_type($nombre, $x);
      $this->mscreg = $x; 
       if ($w > 0) {
